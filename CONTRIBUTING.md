...
* [Help requests](https://github.com/luckywhale13/luckycoin/labels/help%20wanted)
* [Projects](https://github.com/luckywhale13/luckycoin/projects)
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Luckycoin Core
releases will automatically benefit from these.

When refactoring Luckycoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Luckycoin Core, and is not to be
confused with overall Luckycoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Luckycoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Luckycoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Luckycoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Luckycoin consensus, it must have been

Luckycoin Core version 1.14.6 is now available from:
  ...
  <https://github.com/luckywhale13/luckycoin/releases/tag/v1.14.6/>

This is a new minor version release, including important security updates and
changes to network efficiency. All Luckycoin Core users - miners, services,
...
Luckycoin network from 1 DOGE to 0.01 DOGE. The full recommendation can be found
...
efforts to make Luckycoin more accessible to people that do not speak English.
...
* Improved and updated the [bip list](bips.md) documentation that explains the
  protocol features implemented by Luckycoin Core.

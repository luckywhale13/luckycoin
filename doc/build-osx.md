...
1. Clone the luckycoin source code and cd into `luckycoin`
        ...
        git clone https://github.com/luckywhale13/luckycoin
        cd luckycoin
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/luckywhale13/luckycoin/issues/7714)

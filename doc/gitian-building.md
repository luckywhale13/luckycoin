...
`gitian-build.sh` is a standalone script, it can be downloaded and run outside of Luckycoin Core repository.
...
`gitian-build.sh` will create signatures inside `gitian-output/sigs/` folder. Create a pull request to [luckycoin/gitian.sigs](https://github.com/luckywhale13/gitian.sigs) to publish your signatures, the `.assert` and `.assert.sig` files.

**When your PR is merged, you will be recorded for all future history as a *Gitian Builder of Luckycoin Core*!**

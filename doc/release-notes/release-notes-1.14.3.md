Luckycoin Core version 1.14.3 is now available from:

  <https://github.com/luckywhale13/luckycoin/releases/tag/v1.14.3/>
...
Block download timeouts are expressed as a multiple of block interval, and as such Luckycoin block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
...
* Change IPC prefix from `bitcoin:` to `luckycoin:`.

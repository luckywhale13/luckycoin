...
# Dependencies
ossPatchUrl="https://depends.luckycoincore.org/osslsigncode-Backports-to-1.7.1.patch"
ossPatchHash="a8c4e9cafba922f89de0df1f2152e7be286aba73f78505169bc351a7938dd911"

ossTarUrl="https://depends.luckycoincore.org/osslsigncode_1.7.1.orig.tar.gz"
ossTarHash="f9a8cdb38b9c309326764ebc937cba1523a3a751a7ab05df3ecc99d18ae466c9"

macosSdkUrl="https://depends.luckycoincore.org/MacOSX10.11.sdk.tar.gz"
...
SIGNER=
VERSION=
url=https://github.com/luckywhale13/luckycoin
proc=2
mem=2000
...
Standalone script to perform the gitian build of Luckycoin Core. Perform
...
-u|--url repo       Specify the URL of the repository. Default is https://github.com/luckywhale13/luckycoin
...
if [[ $setup == true ]]; then
    ...
    git clone https://github.com/luckywhale13/luckycoin-detached-sigs.git
...
if [[ $build == true ]]; then
    ...
    if [ -d inputs/luckycoin/ ]; then
        echo "Cleaning Luckycoin directory..."

...
/*
 * Luckycoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * Luckycoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
     ...
     */
    CAmount GetLuckycoinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * Luckycoin: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetLuckycoinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
